...
$result = mysqli_query($conn,"SELECT * FROM driver_login WHERE email = '$get_email' and 
			 mobile = '$get_mobile'  ");
...
else
{
	...
	// get customer 
	$result1 = mysqli_query($conn,"INSERT INTO driver_login (name, email, password, mobile,field_1,field_2,field_3, field_4, created_date)
